# Helios Launcher Partie 3: L'écran d'accueil

## Bienvenue

Dans ce tutoriel, nous allons traduire l'écran d'accueil et changer les réseaux sociaux

## Vidéo

Ce tutoriel est la version texte de la vidéo que vous pouvez regardez ci-dessous: 

{% embed url="https://www.youtube.com/watch?v=HsUwhKvBjpc" %}

## Traduire la page d'accueil

Sous `/app/landing.ejs` vous devez traduire l'écran d'accueil. Pour ce faire, je vous ai fournis ci-dessous un exemple de fichier: 
                ...
                <div id="mediaContent">
                    <div id="internalMedia">
                        <div class="mediaContainer" id="settingsMediaContainer">
                            <button class="mediaButton" id="settingsMediaButton">
                                ...
                                <div id="settingsTooltip">Réglages</div>
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="externalMedia">
                        <div class="mediaContainer">
                            <a href="https://github.com/geekcornerght/geeklauncher" class="mediaURL" id="linkURL">
                        ...
                        <div class="mediaContainer">
                            <a href="https://twitter.com/Mojang" class="mediaURL" id="twitterURL">
                        ...
                        <div class="mediaContainer">
                            <a href="https://ytgeek.gq" class="mediaURL" id="youtubeURL">
            ...
            <div class="bot_wrapper">
                <div id="content">
                    ...
                    <div id="mojangStatusWrapper">
                        <span class="bot_label">STATUS DES SERVEURS MOJANG STUDIOS</span>
    ...
    <div id="newsContainer">
        ...
        <div id="newsErrorContainer">
            <div id="newsErrorLoading">
                <span id="nELoadSpan" class="newsErrorContent">Vérification des news...</span>
            </div>
            ...
            <div id="newsErrorNone" style="display: none;">
                <span id="nENoneSpan" class="newsErrorContent">Rien de neuf...</span>
            </div>
        </div>
    </div>
...
Pour les réseaux sociaux, nous avons ligne 30 un élément div qui est assigné à la classe mediaDivider. En dessous, vous avez divers réseaux sociaux. Ceux que vous ne voulez pas, vous les supprimez proprement, et pour les autres, modifiez la valeur de `href` afin de correspondre à vos liens. Puis supprimez le `disabled` afin d'activer les icones.



## Mon skin est torse-nu!!

Moi aussi, mais on va corriger ça! Dans le fichier `/app/assets/js/scripts/landing.js` remplacez simplement en ligne 133 [`https://crafatar.com/renders/body/${authUser.uuid}`](https://crafatar.com/renders/body/${authUser.uuid})par [`https://crafatar.com/renders/head/${accounts[i].uuid}?scale=2&default=MHF_Steve&overlay`](https://crafatar.com/renders/head/${accounts[i].uuid}?scale=2&default=MHF_Steve&overlay)et c'est tout!

## Les status Mojang!

Allez dans `/app/assets/js/mojang.js` puis modifier les valeur `name` afin de pouvoir traduire. Voici ici un exemple:
...
Pour traduire ça, rendez-vous dans le fichier `/app/assets/js/scripts/landing.js` puis lignes 223, 224, et 230, traduisez à votre convenance. Vous devriez avoir un résultat similaire
...
Toujours dans landing.js, ligne 862, traduisez à votre convenance. Vous devriez avoir au final votre fonction qui ressemble à ceci:

```javascript
// extrait de landing.js lignes 860 à 879
...
Nous en avons fini avec la partie 3, j'espère bientôt faire la partie 4. 😊
